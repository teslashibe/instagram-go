...
// message. ClientContext may be supplied to safely reconcile/retry an
// uncertain broadcast; when empty the SDK generates a cryptographically
// random value and returns it in DirectSendResult.
